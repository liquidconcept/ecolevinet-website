module Admin
  class UsersController < Admin::BaseController
    ...
    after_filter  :set_default_plugins_order
  ...
  protected
    ...
    # Reorder Users Plugins after a user modification
    def set_default_plugins_order
      system "/usr/bin/rake maintenance:set_default_plugins_order RAILS_ENV='#{Rails.env}' --trace 2>&1 >> #{Rails.root}/log/rake.log &"
    end
