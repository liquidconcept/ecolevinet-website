...
after 'deploy:update_code' do
  ...
  run "mkdir -p #{File.join(shared_path,'vinetprofs')} && rm -f #{File.join(release_path,'public','vinetprofs')} && ln -s #{File.join(shared_path,'vinetprofs')} #{File.join(release_path,'public','vinetprofs')}"
end
